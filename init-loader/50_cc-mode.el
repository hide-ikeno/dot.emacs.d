...
;;;
;;; File: ~/.emacs.d/conf/init-cc-mode.el
;;; Description: Customize cc-mode
;;;
;;; Code:
...
(declare-function my-cc-mode--copy-face "50_cc-mode" (src dest))
...
(use-package cc-mode
  ...
  (defun my-cc-mode--copy-face (new-face face)
    "Define NEW-FACE from existing FACE."
    (copy-face face new-face)
    (eval `(defvar ,new-face nil))
    (set new-face new-face))
  ;; labels, case, public, private, proteced, namespace-tags
  (my-cc-mode--copy-face 'font-lock-label-face 'font-lock-keyword-face)
  ;; comment markups such as Javadoc-tags
  (my-cc-mode--copy-face 'font-lock-doc-markup-face 'font-lock-doc-face)
  ;; comment markups
  (my-cc-mode--copy-face 'font-lock-doc-string-face 'font-lock-comment-face)
  ;; (setq font-lock-maximum-decoration t)

  (defun my-cpp11--add-keywords ()
    (font-lock-add-keywords
     ...
     t))
  ;; We could place some regexes into `c-mode-common-hook', but note that their
  ;; evaluation order matters.
  (add-hook 'c++-mode-hook 'my-cpp11--add-keywords())
  )
